<?php  
	$this->set_css($this->default_theme_url_path.'/flexigrid/css/flexigrid.css');
	$this->set_js($this->default_javascript_path.'/'.grocery_CRUD::JQUERY);
	$this->set_js($this->default_theme_url_path.'/flexigrid/js/cookies.js');
	$this->set_js($this->default_theme_url_path.'/flexigrid/js/flexigrid.js');
	$this->set_js($this->default_theme_url_path.'/flexigrid/js/jquery.form.js');
	$this->set_js($this->default_theme_url_path.'/flexigrid/js/jquery.numeric.js');
	$this->set_js($this->default_theme_url_path.'/flexigrid/js/jquery.printElement.min.js');
