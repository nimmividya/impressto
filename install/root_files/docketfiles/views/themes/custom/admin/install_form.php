...
<head>
    ...
    <title>Admin | pageShaper 2.0</title>
    ...
    <!-- stylesheets -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/<?php echo PROJECTNAME; ?>/core/css/reset.css" media="all" />
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/<?php echo PROJECTNAME; ?>/core/css/style.css" media="screen" />
	<!--[if lte IE 7]>
...
<input type="submit" value="Install PageShaper">
