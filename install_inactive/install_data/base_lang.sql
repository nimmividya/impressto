...
CREATE TABLE IF NOT EXISTS `{$dbprefix}contentarchives_{$lang}` (
  ...
  `CO_Body` longtext NOT NULL DEFAULT '',
  `CO_MobileBody` longtext NOT NULL DEFAULT '',
  `CO_WhenModified` datetime DEFAULT NULL,
  `CO_ModifiedBy` varchar(75) DEFAULT NULL,
  `prevpage`  varchar(250) DEFAULT '',
  `nextpage`  varchar(250) DEFAULT '',
  `mobile_prevpage`  varchar(250) DEFAULT '',
  `mobile_nextpage`  varchar(250) DEFAULT '',  
  `CO_Javascript` text,
...
CREATE TABLE IF NOT EXISTS `{$dbprefix}searchtags_{$lang}` (
  ...
  `frequency` int(8) NOT NULL DEFAULT '0',
