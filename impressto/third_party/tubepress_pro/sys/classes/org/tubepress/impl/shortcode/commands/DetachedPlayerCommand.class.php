...
{
    private static $_logPrefix = 'Detached Player Command';
    ...
    public function execute($context)
    {
        ...
        if ($execContext->get(org_tubepress_api_const_options_names_Output::OUTPUT) !== org_tubepress_api_const_options_values_OutputValue::PLAYER
            ...
            org_tubepress_impl_log_Log::log(self::$_logPrefix, 'Not set to show output or no gallery ID set');
            return false;
        }
        ...
        org_tubepress_impl_log_Log::log(self::$_logPrefix, 'Provider has delivered %d videos', $numVideos);
