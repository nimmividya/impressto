...
class org_tubepress_impl_html_DefaultHeadHtmlGenerator implements org_tubepress_api_html_HeadHtmlGenerator
{
	...
	// peterdrinnan Jnuie 07, 2012 - added this to move assets away from main package
    private $_tubepressAssetUrl;
	
    public function __construct()
    {
        global $tubepress_base_url;
        global $tubepress_asset_url;
		
        $this->_tubepressBaseUrl = $tubepress_base_url;
        $this->_tubepressAssetUrl = $tubepress_asset_url;
		
    }

    public function getHeadJqueryInclusion()
    {
        $url = $this->_tubepressAssetUrl;
        return "<script type=\"text/javascript\" src=\"$url/static/js/jquery-1.7.1.min.js\"></script>";
    }
    ...
    {
        $url = $this->_tubepressAssetUrl;
        return "<script type=\"text/javascript\" src=\"$url/static/js/tubepress.js\"></script>";
    }

    public function getHeadCssIncludeString()
    {
        $url = $this->_tubepressAssetUrl;
        return "<link rel=\"stylesheet\" href=\"$url/themes/default/style.css\" type=\"text/css\" />";
    }
