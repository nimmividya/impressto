...
class TubePressPro
{
    public static function getHtmlForHead($includeJQuery = false)
    {
        ...
        $htmlGenerator = $ioc->get(org_tubepress_api_html_HeadHtmlGenerator::_);
...
EOT;
    ...
    public static function getHtmlForShortcode($raw_shortcode = '')
    {
        ...
        $ioc           = org_tubepress_impl_ioc_IocContainer::getInstance();
        $bootstrapper  = $ioc->get(org_tubepress_api_bootstrap_Bootstrapper::_);
        $htmlGenerator = $ioc->get(org_tubepress_api_shortcode_ShortcodeHtmlGenerator::_);
    ...
    private static function _cleanShortcode($shortcode)
    {
        ...
        $trigger = $context->get(org_tubepress_api_const_options_names_Advanced::KEYWORD);
        $lookFor = "[$trigger ";
