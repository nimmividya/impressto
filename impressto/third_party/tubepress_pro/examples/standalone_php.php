 ...
 */
$tubepress_base_url = 'http://wordpress_sandbox.local/tubepress_pro/';
 ...
 */
include (getenv("DOCUMENT_ROOT") . '/tubepress_pro/sys/classes/TubePressPro.class.php');
...
<html>
    ...
    <body>
		<div>
			...
			-->
            <?php 
			///playerLocation="normal"
			
			//print TubePressPro::getHtmlForShortcode("resultsPerPage='10' mode='user' playerLocation='fancybox' ajaxPagination='true'"); 
			
			print TubePressPro::getHtmlForShortcode("resultsPerPage='10' mode='user' userValue='peterdrinnan' playerLocation='normal' ajaxPagination='true'"); 
			
			//mode="user" userValue="3hough"
