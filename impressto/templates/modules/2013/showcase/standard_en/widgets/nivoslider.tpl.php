...
<!-- BEGIN IMAGEGALLERYMAINBODY -->
   ...
   <div class="gallery_landing clearfix">
	  ...
	  ?>
        ...
        <li>
          <a href="javascript:ps_image_gallery.loadcategory_by_id('<?=$id?>');"> <span>&nbsp;</span> <img alt="<?=$catvals['name_en']?>" height="152" src="/assets/upload/<?php echo PROJECTNAME; ?>/image_gallery/<?=$id?>/thumbs/<?=$catvals['imagename']?>" width="152" /> <?=$catvals['name_en']?> </a>
		</li>
...
<?php	  
		...
		foreach($category_images as $key => $val){
			...
			$imgpath = "/assets/upload/" . PROJECTNAME  . "/image_gallery/{$ig_category}/";
