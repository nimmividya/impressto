...
<div id="ps_version_confirm_notice" class="alert alert-block alert-error fade in">
	...
	<p>
		...
		<a href="http://www.myapp.ca/changelogs/<?=$current_version?>">See the full change log</a>.</p>
	<p>
...
<ul>
	<li><a href="http://bitmobile.bitheads.com/kb/" target="_blank">Getting Started</a></li>
	<li><a href="http://bitmobile.bitheads.com/kb/" target="_blank">bitHeads Central Developer Guide</a></li>
</ul>
