...
*/		
	...
	$this->asset_loader->add_header_css_top(ASSETURL . PROJECTNAME . "/default/themes/haaki/css/style.css","","all");
		...
		//$this->asset_loader->add_header_css_top(ASSETURL . PROJECTNAME . "/default/themes/haaki/css/base_style.css","","all");
		//$this->asset_loader->add_header_css_top(ASSETURL . PROJECTNAME . "/default/themes/haaki/css/haaki_style.css","","all");	

		
		
		if($this->config->item('thirdpartypopup') == FALSE || $this->config->item('thirdpartypopup') == "") {

			//$this->asset_loader->add_header_css_top(ASSETURL . PROJECTNAME . "/default/themes/haaki/img/splashy/splashy.css","","all");
		...
		//$this->asset_loader->add_header_css_top(ASSETURL . PROJECTNAME . "/default/themes/haaki/css/print.css","","print");
