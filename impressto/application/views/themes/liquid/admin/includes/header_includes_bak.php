...
?>
	...
	<?php
		...
		if($this->config->item('thirdpartypopup') == FALSE || $this->config->item('thirdpartypopup') == "") {
			$this->asset_loader->add_header_css_top("vendor/bootstrap/css/bootstrap-responsive.min.css","","all");
		...
		if($this->config->item('thirdpartypopup') == FALSE || $this->config->item('thirdpartypopup') == "") {
			...
			$this->asset_loader->add_header_css_top(ASSETURL . PROJECTNAME . "/default/vendor/jBreadcrumbs/css/BreadCrumb.css","","all");
			$this->asset_loader->add_header_css_top(ASSETURL . PROJECTNAME . "/default/vendor/jquery/plugins/qtip2/jquery.qtip.min.css","","all");
