    ...
    <body class="login_page">
		...
		<div class="login_box">
			...
			<form action="/auth/validate_credentials" method="post" accept-charset="utf-8" id="login_form">
				...
				<div class="top_b">Sign in to <?=$site_title?></div>    
			...
			<form action="dashboard.html" method="post" id="pass_form" style="display:none">
				<div class="top_b">Can't sign in?</div>    
					...
					<div class="alert alert-error alert-login" style="display:none" id="forgot_pass_error_div"></div>
		...
		$this->asset_loader->add_header_js(ASSETURL . PROJECTNAME . "/default/core/js/appbase.js");
		$this->asset_loader->add_header_js(ASSETURL . PROJECTNAME . "/default/core_modules/login/js/login.js");
