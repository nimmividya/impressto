...
class package_manager_model extends My_Model{
	...
	*/	
	public function get_packages(){
		...
		// read the database and return a list of all the packages and the versions.
		
		$sql = "SELECT * FROM {$this->db->dbprefix}installer_packages ORDER BY updated ASC";
