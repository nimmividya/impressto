...
class remote extends PSBase_Controller {
	...
	*/
	...
	/**
	* Ajax responder that checks the pageshaper.ca server to determine if any updates are available for 
	* a specific module
	...
	*/
	public function check_for_module_update($module_dirname, $module_type, $version = null){
		...
		// user curl here to connect to the pageshaper API server to request module info
	...
	public function install_module_update($module_dirname, $module_type, $version){
		...
		$sourceurl = "http://pageshaper.ca/assets/uploads/pshaper/api/modus/" . $module_dirname . "/" . $module_dirname . "_" . $version . ".zip";
