...
function get_category_selector_options(){
	...
	$sql = "SELECT id, name AS name_en, name_fr FROM {$this->db->dbprefix('showcase_categories')} ORDER BY position ASC";
...
function get_category_selector(){
	...
	$sql = "SELECT * FROM {$this->db->dbprefix('showcase_categories')} ORDER BY position ASC";
...
public function get_widget_id(){
	...
	$sql = "SELECT widget_id FROM {$this->db->dbprefix('widgets')} WHERE module = 'showcase' AND widget = 'showcase' AND instance = '' ";
	...
	*/
	public function getCategoryIdByName($category){
		...
		$query = $this->db->get_where("showcase_categories", array("name"=>$category));
	...
	*/
	public function getGalleryIdByName($gallery_name){
		...
		$query = $this->db->get_where("showcases", array("name"=>$gallery_name));
	...
	*/
	public function getGallerySettings($gallery){
		...
		$query = $this->db->get_where("showcase_settings", array("gallery"=>$gallery));
...
public function get_display_categories(){
	...
	$sql = "SELECT categories.*, gallery.imagename FROM {$this->db->dbprefix}showcase_categories AS categories ";
	$sql .= " LEFT JOIN {$this->db->dbprefix}showcase_items AS gallery ON categories.category_image = gallery.id "; 
...
public function get_images($gallery, $category = ""){
	...
	$sql = "SELECT * FROM {$this->db->dbprefix('showcase_items')} WHERE gallery = '{$gallery}' ";
...
public function get_category_name($category_id, $lang = "en"){
	...
	$sql = "SELECT name AS name_en, name_fr FROM {$this->db->dbprefix('showcase_categories')} WHERE id = '{$category_id}'";
