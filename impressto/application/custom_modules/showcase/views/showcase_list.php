...
<td style="vertical-align: top"><?=$val['imagename']?><br /><img id="imagelist_thumb_<?=$id?>" src="<?php echo ASSETURL; ?>uploads/<?php echo PROJECTNAME; ?>/showcase/<?=$gallery?>/<?=$val['category']?>/thumbs/<?=$val['imagename']?>"></td>
