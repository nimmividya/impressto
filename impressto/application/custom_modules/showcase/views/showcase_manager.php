					...
					<div class="w-box-content cnt_a">
						...
						<div style="float:left">
							...
							<div style="display:none" id="initcrop_div">
								<a onclick="ps_imagegallerymanager.opencropbox()"><img src="<?php echo ASSETURL; ?><?php echo PROJECTNAME; ?>/default/custom_modules/showcase/images/img_crop.png" alt="cropper" border="0" /> Crop Thumbnail</a>
							</div>
...
<div id="image_cropping_div" class="modal hide fade in" style="display: none; ">
            ...
            <div class="modal-footer">
              <a onclick="ps_imagegallerymanager.savecrop_dimensions()" class="btn btn-success"><img src="<?php echo ASSETURL; ?><?php echo PROJECTNAME; ?>/default/custom_modules/showcase/images/saving_crop.png" alt="Save Crop" width="16" height="16" style="vertical-align: middle;margin: 0 5px 0 0;"/> Save Cropping</a>
