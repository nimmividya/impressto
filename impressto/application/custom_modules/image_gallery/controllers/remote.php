...
class remote extends PSBase_Controller {
	...
	*/
	public function showcat(){
		...
		$data['category_images'] = $this->image_gallery_model->get_images($this->input->get('ig_category'));
		
		//get the category layout. 		
		$data['category_options'] = $this->image_gallery_model->get_category_selector_options();
		...
		'options'          => $this->image_gallery_model->get_category_selector_options(),
		'onchange' => 'ps_image_gallery.loadcategory(this)',
		...
		$data['category_name'] = $this->image_gallery_model->get_category_name($data['ig_category'], $lang);
