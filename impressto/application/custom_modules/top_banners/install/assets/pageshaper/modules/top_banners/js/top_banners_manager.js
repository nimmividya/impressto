...
success: function (data, status)
		{
			if(typeof(data.error) != 'undefined')
			{
				...
				{		
					...
					jQuery('#thumbnail_holder_div').html('<strong>Image thumbnail</strong><br /><img id="preview_thumb" style="margin: 5px 0 0;" src="<?php echo ASSETURL; ?>upload/<?php echo PROJECTNAME; ?>/bg_pos_slider/images/thumbs/' + data.thumbname + '"><br /><a style="margin:10px 0 0;display:inline-block;" href="javascript:insertthumb(\'' + data.thumbname  + '\')"><img src="<?php echo ASSETURL; ?><?php echo PROJECTNAME; ?>/default/custom_modules/bg_pos_slider/images/add_plus.png" title="Insert Image Into Editor" alt="Add" /></a>&nbsp;<a style="margin:10px 0 0 5px;display:inline-block;" href="javascript:activatecrop(\'' + data.thumbname  + '\')"><img src="<?php echo ASSETURL; ?><?php echo PROJECTNAME; ?>/default/custom_modules/bg_pos_slider/images/img_crop.png" title="Crop Image" alt="Crop" /></a><br />');
