...
class commento extends PSAdmin_Controller {
	...
	*/
	public function index($area = "", $subarea = ""){
		...
		$this->asset_loader->add_header_css(ASSETURL . PROJECTNAME  . "/default/vendor/mincolors/jquery.miniColors.css");
		
		$this->asset_loader->add_header_js(ASSETURL . PROJECTNAME . "/custom_modules/commento/js/commento_admin_engine.js");
		$this->asset_loader->add_header_js(ASSETURL . PROJECTNAME  . "/default/vendor/mincolors/jquery.miniColors.js");
