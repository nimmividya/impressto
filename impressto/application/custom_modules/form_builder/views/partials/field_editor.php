...
<form class="add_new_field" method="post">
<input type="hidden" id="field_id" name="field_id" value="<?=$field_id?>" />
<input type="hidden" id="field_form_id" name="field_form_id" value="<?=$form_id?>" />
...
<div class="buttonbar clearfix">
	...
	<button type="button" class="btn" onclick="ps_formbuilder_manager.cancel_field_edit()" id="btn_add_new">Cancel</button>
	<button type="button" class="btn btn-success" onclick="ps_formbuilder_manager.save_field()" id="btn_add_new"><i class="icon-white icon-ok"></i> Save</button>
	</div>
</div>
	...
	<script>  ps_formbuilder_manager.init_width_slider('<?=$width?>'); </script>
	...
	<script>  ps_formbuilder_manager.init_height_slider('<?=$height?>'); </script>
