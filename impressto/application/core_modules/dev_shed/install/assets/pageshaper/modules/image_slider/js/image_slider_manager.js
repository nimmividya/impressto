...
success: function (data, status)
		{
			if(typeof(data.error) != 'undefined')
			{
				...
				{		
					...
					jQuery('#thumbnail_holder_div').html('<strong>Image thumbnail</strong><br /><img id="preview_thumb" style="margin: 5px 0 0;" src="/assets/upload/bg_pos_slider/images/thumbs/' + data.thumbname + '"><br /><a style="margin:10px 0 0;display:inline-block;" href="javascript:insertthumb(\'' + data.thumbname  + '\')"><img src="/assets/' + ps_base.appname + '/modules/bg_pos_slider/images/add_plus.png" title="Insert Image Into Editor" alt="Add" /></a>&nbsp;<a style="margin:10px 0 0 5px;display:inline-block;" href="javascript:activatecrop(\'' + data.thumbname  + '\')"><img src="/assets/' + ps_base.appname + '/modules/bg_pos_slider/images/img_crop.png" title="Crop Image" alt="Crop" /></a><br />');
...
function insertthumb(thumbimg){
	...
	var data = '<a href="/assets/upload/bg_pos_slider/images/' + thumbimg + '" rel="lightbox"><img border="0" src="' + thumb_src + '" alt="thumb_image" /></a>';
...
function activatecrop(imagename){
	...
	if(jcrop_api == ""){
		...
		jQuery('#crop_box').attr('src','/assets/upload/bg_pos_slider/images/' + imagename);
		initJcrop();
		
		
	}else{
		
		jcrop_api.setImage('/assets/upload/bg_pos_slider/images/' + imagename);
