...
<div style="padding:3px; border: 1px solid #888888; background-color:#FFFFFF;">
	...
	<div style="width:428px; height:18px; background-color:#DDDDDD; color:#333333; font-weight:bold; padding:2px;">
		...
		<div style="float:right">
			<img src="{$core_asset_url}/images/actionicons/add.gif" alt="Add" title="Add" onclick="userfield_manager.add_option('{$element_id}')">
	</div>
...
<div onclick="userfield_manager.set_default_option('{$i}')" id="option_default_icon_{$i}" class="defaultstar{$defaultstaractiveflag}">&nbsp;</div>
<div onclick="userfield_manager.delete_option('{$option_id}')" class="deleteoption_icon">&nbsp;</div>
