...
class grocery_CRUD extends grocery_CRUD_States
{
	...
	protected $default_theme_url_path				= null; //autogenerate, please do not modify
	...
	public function set_default_language_path($val){

		$this->default_language_path = $val;
	}
	
	
	public function set_default_config_path($val){
	
		$this->default_config_path = $val;
...
//@todo ui_day, ui_month, ui_year has to be lang strings
	...
	protected function _initialize_variables()
	{
		...
		$this->default_theme_url_path				= $this->default_assets_url_path.'/themes';
		
		$this->default_javascript_path				= $this->default_assets_url_path . '/js';
		$this->default_css_path						= $this->default_assets_url_path . '/css';
	...
	public function get_table()
	{
		...
		elseif( $this->basic_db_table !== null )
		{
			...
			{
				throw new Exception('The table name ' . $this->basic_db_table . ' does not exist. Please check you database and try again.',11);
				die();
			}
