...
class Events_Commento {
    ...
    public function __construct()
    {
		...
		Events::register('show_content', array($this, 'show_commento'));
	...
	/**
	* Adds comment to any sepcified content type
	* 
	*/
	public function show_commento( $data )
    {
        $CI =& get_instance();	
		...
		if(isset($data['blog_id'])){
			...
			Widget::run('commento/commento', array('content_type'=>$data['content_type'],'content_id'=>$data['content_id']));
